...
const steps = [
  ...
  },
  {
    ...
    description: 'Record a video of the retina using your device camera and select a frame, or upload an existing image or video. For best results, ensure the visual input is clear and well-lit.',
