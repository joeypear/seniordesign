...
export default function ScanDetailScreen({ scan, scansLoading, onBack, onUpdateNotes, onRenameScan, onDeleteScan }) {
  ...
  return (
    ...
    >
      ...
      {/* Top bar */}
      <div className="sticky top-0 z-30 bg-white/85 dark:bg-[#1A1D2E]/90 backdrop-blur-md border-b border-gray-100 dark:border-[#2E3350] flex items-stretch gap-3 px-4" style={{ minHeight: 64 }}>
        <button
          onClick={onBack}
